...
Route::get('/dashboard', AdminPageComponent::class)->name('dashboard')->middleware('auth');
Route::get('/blog', BlogComponent::class)->name('blog');
Route::get('/blog/{slug}', BlogDetailComponent::class)->name('blog.detail')->middleware('auth');
